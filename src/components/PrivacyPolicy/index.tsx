...
const PrivacyPolicy: React.FC = (): JSX.Element => {
  return (
    <PrivacyPolicyContainer>
      <h1>Política de Privacidade da Watch Store</h1>
      <p>
        A sua privacidade é importante para nós. É política do Watch Store
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Watch Store, e outros sites que possuímos e
        operamos.
      </p>
      <p>
      ...
      <ul className="second-list">
        ...
        <p>
          ...
          informação que o Watch Store oferece no site e com caráter
        ...
        <li>
          ...
          (softwares) do Watch Store, de seus fornecedores ou terceiros, para
